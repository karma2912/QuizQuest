...
const Progress = () => {
  return (
    <div className='m-12 bg-red-500 h-48 flex justify-around items-center text-xl'>
      ...
      <div className='h-14 w-20 bg-orange-400 flex justify-center items-center rounded-3xl'>2</div>
      ...
      <div className='h-14 w-28 bg-orange-400 flex justify-center items-center rounded-3xl'>Next</div>
    </div>
  )
}
