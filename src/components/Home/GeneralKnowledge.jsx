...
const GeneralKnowledge = () => {
  return (
    <div className='md:h-[32rem] h-[82rem] md:w-11/12 w-full flex md:flex-row flex-col justify-between items-center rounded-2xl'>
      ...
      <i className="fa-solid md:fa-arrow-right fa-arrow-down ml-3 text-8xl just"></i>
      <div className='text-5xl md:w-[55rem] w-full bg-yellow-300 font-bold md:p-16 p-10 rounded-2xl border-2 border-yellow-500 shadow-2xl'>General Knowledge
