...
const ClgSubject = () => {
  return (
    ...
    <div className='text-5xl md:w-[55rem] w-full bg-yellow-300 font-bold md:p-16 p-10 rounded-2xl border-2 border-yellow-500 shadow-2xl'>Institutional Subjects
    ...
    <i className="fa-solid md:fa-arrow-right fa-arrow-up ml-3 text-8xl just"></i>
