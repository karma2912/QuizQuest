...
const ClgSubject = () => {
  return (
    ...
    <div className='text-5xl w-[55rem] bg-yellow-300 font-bold p-16 rounded-2xl border-2 border-yellow-500 shadow-2xl'>Institutional Subjects
    ...
    <i className="fa-solid fa-arrow-left ml-3 text-8xl just"></i>
